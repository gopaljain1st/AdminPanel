      ...
      snapshot.forEach(function(childSnapshot)
      {
        ...
        var jobData=childSnapshot.val();
          ...
          if(jobData.job_status=="Completed")
          {
            ...
            cell4.innerHTML = "";
            cell7.innerHTML = cell7.innerHTML + "<input type='button' data-toggle='modal' data-target='#myModal'  value='PAY' style='background-color: green; border: none; height: 25px; width: 70px; color: white; font-size: 15px; border-radius: 10px; margin-top: 15px; cursor: pointer'/>";
            count++;
          }
      });
    });
